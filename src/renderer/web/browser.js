/**
 * Web implementation of the app API.
 * Used when running in a normal browser and talking to the backend API.
 */
...
function openExportFolder() {
  // No-op in browser; confirmation screen hides the button when isBrowser is true
}
